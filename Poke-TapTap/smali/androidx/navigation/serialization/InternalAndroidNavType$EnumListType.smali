...
.method public equals(Ljava/lang/Object;)Z
    ...
    check-cast v1, Landroidx/navigation/serialization/InternalAndroidNavType$EnumListType;

    iget-object v1, v1, Landroidx/navigation/serialization/InternalAndroidNavType$EnumListType;->enumNavType:Landroidx/navigation/NavType$EnumType;
...
.method public bridge synthetic parseValue(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/navigation/serialization/InternalAndroidNavType$EnumListType;->parseValue(Ljava/lang/String;Ljava/util/List;)Ljava/util/List;
...
.method public bridge synthetic put(Landroid/os/Bundle;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2, v0}, Landroidx/navigation/serialization/InternalAndroidNavType$EnumListType;->put(Landroid/os/Bundle;Ljava/lang/String;Ljava/util/List;)V
...
.method public put(Landroid/os/Bundle;Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 143
    .local v1, "$i$a$-let-InternalAndroidNavType$EnumListType$put$1":I
    ...
    .end local v1    # "$i$a$-let-InternalAndroidNavType$EnumListType$put$1":I
    goto :goto_0
...
.method public bridge synthetic serializeAsValues(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-virtual {p0, v0}, Landroidx/navigation/serialization/InternalAndroidNavType$EnumListType;->serializeAsValues(Ljava/util/List;)Ljava/util/List;
...
.method public serializeAsValues(Ljava/util/List;)Ljava/util/List;
    ...
    .line 161
    .local v8, "$i$a$-map-InternalAndroidNavType$EnumListType$serializeAsValues$1":I
    ...
    .end local v8    # "$i$a$-map-InternalAndroidNavType$EnumListType$serializeAsValues$1":I
...
.method public bridge synthetic valueEquals(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/navigation/serialization/InternalAndroidNavType$EnumListType;->valueEquals(Ljava/util/List;Ljava/util/List;)Z
...
.method public valueEquals(Ljava/util/List;Ljava/util/List;)Z
    ...
    .line 155
    .local v2, "$i$a$-let-InternalAndroidNavType$EnumListType$valueEquals$valueArrayList$1":I
    ...
    .end local v2    # "$i$a$-let-InternalAndroidNavType$EnumListType$valueEquals$valueArrayList$1":I
    goto :goto_0
    ...
    .line 156
    .local v3, "valueArrayList":Ljava/util/ArrayList;
    :goto_0
    if-eqz p2, :cond_1
    ...
    .line 156
    .local v1, "$i$a$-let-InternalAndroidNavType$EnumListType$valueEquals$otherArrayList$1":I
    new-instance v2, Ljava/util/ArrayList;
    ...
    .line 157
    .end local v1    # "$i$a$-let-InternalAndroidNavType$EnumListType$valueEquals$otherArrayList$1":I
    .local v0, "otherArrayList":Ljava/util/ArrayList;
    :cond_1
