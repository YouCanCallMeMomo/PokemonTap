...
.method public get(Landroid/os/Bundle;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 433
    .local v3, "$i$a$-read-InternalNavType$DoubleListType$1$get$1":I
    ...
    invoke-static {v4}, Lkotlin/collections/ArraysKt;->toList([D)Ljava/util/List;
    ...
    .end local v3    # "$i$a$-read-InternalNavType$DoubleListType$1$get$1":I
    :goto_0
    nop
...
.method public put(Landroid/os/Bundle;Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 427
    .local v3, "$i$a$-write-InternalNavType$DoubleListType$1$put$1":I
    if-nez p3, :cond_0
    ...
    invoke-static {v2, p2, v4}, Landroidx/savedstate/SavedStateWriter;->putDoubleArray-impl(Landroid/os/Bundle;Ljava/lang/String;[D)V
    ...
    .end local v3    # "$i$a$-write-InternalNavType$DoubleListType$1$put$1":I
    nop
...
.method public serializeAsValues(Ljava/util/List;)Ljava/util/List;
    ...
    .line 449
    .local v9, "$i$a$-map-InternalNavType$DoubleListType$1$serializeAsValues$1":I
    ...
    .line 463
    .end local v7    # "it":D
    .end local v9    # "$i$a$-map-InternalNavType$DoubleListType$1$serializeAsValues$1":I
...
.method public valueEquals(Ljava/util/List;Ljava/util/List;)Z
    ...
    .line 444
    .local v2, "valueArray":[Ljava/lang/Double;
    if-eqz p2, :cond_1
    ...
    .line 445
    .local v1, "otherArray":[Ljava/lang/Double;
