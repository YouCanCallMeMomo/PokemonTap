...
.method private final startAnimations(Ljava/util/List;Ljava/util/List;ZLjava/util/Map;)V
    ...
    .line 140
    .local v7, "animationsToRun":Ljava/util/List;
    const/4 v0, 0x0
    ...
    .line 148
    .local v12, "anim":Landroidx/fragment/app/FragmentAnim$AnimationOrAnimator;
    if-nez v12, :cond_1
    ...
    .line 153
    :cond_1
    iget-object v13, v12, Landroidx/fragment/app/FragmentAnim$AnimationOrAnimator;->animator:Landroid/animation/Animator;
    ...
    invoke-direct {v9, v13, v4}, Landroidx/fragment/app/DefaultSpecialEffectsController$$ExternalSyntheticLambda0;-><init>(Landroid/animation/Animator;Landroidx/fragment/app/SpecialEffectsController$Operation;)V

    invoke-virtual {v0, v9}, Landroidx/core/os/CancellationSignal;->setOnCancelListener(Landroidx/core/os/CancellationSignal$OnCancelListener;)V

    move/from16 v0, v17

    .end local v0    # "signal":Landroidx/core/os/CancellationSignal;
    .end local v2    # "viewToAnimate":Landroid/view/View;
    .end local v3    # "isHideOperation":Z
    ...
    .end local v12    # "anim":Landroidx/fragment/app/FragmentAnim$AnimationOrAnimator;
    ...
    .line 244
    .local v12, "viewToAnimate":Landroid/view/View;
    invoke-static {v6, v2}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    iget-object v13, v13, Landroidx/fragment/app/FragmentAnim$AnimationOrAnimator;->animation:Landroid/view/animation/Animation;
    ...
    invoke-virtual {v11, v12}, Landroid/view/ViewGroup;->startViewTransition(Landroid/view/View;)V
    ...
    .line 256
    invoke-direct {v11, v13, v0, v12}, Landroidx/fragment/app/FragmentAnim$EndViewTransitionAnimation;-><init>(Landroid/view/animation/Animation;Landroid/view/ViewGroup;Landroid/view/View;)V
    ...
    new-instance v11, Landroidx/fragment/app/DefaultSpecialEffectsController$startAnimations$3;

    invoke-direct {v11, v5, v1, v12, v4}, Landroidx/fragment/app/DefaultSpecialEffectsController$startAnimations$3;-><init>(Landroidx/fragment/app/SpecialEffectsController$Operation;Landroidx/fragment/app/DefaultSpecialEffectsController;Landroid/view/View;Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;)V
    ...
    .local v18, "animation":Landroid/view/animation/Animation;
    ...
    .line 284
    .end local v18    # "animation":Landroid/view/animation/Animation;
    ...
    .line 291
    .local v0, "signal":Landroidx/core/os/CancellationSignal;
    new-instance v11, Landroidx/fragment/app/DefaultSpecialEffectsController$$ExternalSyntheticLambda1;

    invoke-direct {v11, v12, v1, v4, v5}, Landroidx/fragment/app/DefaultSpecialEffectsController$$ExternalSyntheticLambda1;-><init>(Landroid/view/View;Landroidx/fragment/app/DefaultSpecialEffectsController;Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;Landroidx/fragment/app/SpecialEffectsController$Operation;)V

    invoke-virtual {v0, v11}, Landroidx/core/os/CancellationSignal;->setOnCancelListener(Landroidx/core/os/CancellationSignal$OnCancelListener;)V
    ...
    .end local v12    # "viewToAnimate":Landroid/view/View;
    ...
    .end local v17    # "startedAnyAnimator":Z
    .local v0, "startedAnyAnimator":Z
    .restart local v4    # "animationInfo":Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;
    .restart local v5    # "operation":Landroidx/fragment/app/SpecialEffectsController$Operation;
    .restart local v8    # "fragment":Landroidx/fragment/app/Fragment;
    .restart local v12    # "viewToAnimate":Landroid/view/View;
    :cond_f
    move/from16 v17, v0
...
.method private final startTransitions(Ljava/util/List;Ljava/util/List;ZLandroidx/fragment/app/SpecialEffectsController$Operation;Landroidx/fragment/app/SpecialEffectsController$Operation;)Ljava/util/Map;
    ...
    .line 327
    .local v8, "transitionImpl":Landroidx/fragment/app/FragmentTransitionImpl;
    if-nez v8, :cond_a
    ...
    .line 330
    .local v6, "transitionInfo":Landroidx/fragment/app/DefaultSpecialEffectsController$TransitionInfo;
    ...
    .end local v6    # "transitionInfo":Landroidx/fragment/app/DefaultSpecialEffectsController$TransitionInfo;
    goto :goto_6
    ...
    .line 342
    .local v5, "nonExistentView":Landroid/view/View;
    const/4 v6, 0x0
    ...
    .line 344
    .local v7, "firstOutEpicenterView":Landroid/view/View;
    const/4 v9, 0x0
    ...
    .line 352
    .local v28, "hasSharedElementTransition":Z
    if-eqz v28, :cond_23
    ...
    .local v29, "hasLastInEpicenter":Z
    ...
    .line 354
    invoke-virtual {v8, v9}, Landroidx/fragment/app/FragmentTransitionImpl;->wrapTransitionInSet(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 361
    .local v9, "exitingNames":Ljava/util/ArrayList;
    ...
    .end local v7    # "firstOutEpicenterView":Landroid/view/View;
    ...
    .line 362
    .local v15, "firstOutSourceNames":Ljava/util/ArrayList;
    invoke-virtual {v2}, Landroidx/fragment/app/SpecialEffectsController$Operation;->getFragment()Landroidx/fragment/app/Fragment;
    ...
    .local v32, "startedTransitions":Ljava/util/Map;
    const-string v4, "firstOut.fragment.sharedElementTargetNames"

    invoke-static {v7, v4}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    .line 365
    .local v7, "firstOutTargetNames":Ljava/util/ArrayList;
    const/4 v4, 0x0
    ...
    .local v5, "index":I
    .local v33, "nonExistentView":Landroid/view/View;
    :goto_8
    ...
    .line 385
    .local v5, "enteringCallback":Landroidx/core/app/SharedElementCallback;
    move-object/from16 v35, v7

    .end local v7    # "firstOutTargetNames":Ljava/util/ArrayList;
    .local v35, "firstOutTargetNames":Ljava/util/ArrayList;
    ...
    .local v15, "i":I
    .local v36, "firstOutSourceNames":Ljava/util/ArrayList;
    :goto_a
    if-ge v15, v7, :cond_e
    ...
    .line 389
    .local v15, "enteringName":Ljava/lang/String;
    move-object/from16 v25, v13

    .end local v13    # "sharedElementLastInViews":Ljava/util/ArrayList;
    .local v25, "sharedElementLastInViews":Ljava/util/ArrayList;
    move-object v13, v14
    ...
    .end local v15    # "enteringName":Ljava/lang/String;
    ...
    .end local v25    # "sharedElementLastInViews":Ljava/util/ArrayList;
    .end local v37    # "numSharedElements":I
    .local v7, "numSharedElements":I
    .restart local v13    # "sharedElementLastInViews":Ljava/util/ArrayList;
    :cond_e
    move/from16 v37, v7
    ...
    .end local v13    # "sharedElementLastInViews":Ljava/util/ArrayList;
    .end local v15    # "i":I
    .restart local v25    # "sharedElementLastInViews":Ljava/util/ArrayList;
    .restart local v37    # "numSharedElements":I
    ...
    .line 405
    .local v7, "firstOutViews":Landroidx/collection/ArrayMap;
    move-object v13, v7
    ...
    .local v19, "sharedElementTransition":Ljava/lang/Object;
    const-string v6, "firstOut.fragment.mView"

    invoke-static {v15, v6}, Lkotlin/jvm/internal/Intrinsics;->checkNotNullExpressionValue(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-direct {v0, v13, v15}, Landroidx/fragment/app/DefaultSpecialEffectsController;->findNamedViews(Ljava/util/Map;Landroid/view/View;)V
    ...
    invoke-virtual {v7, v6}, Landroidx/collection/ArrayMap;->retainAll(Ljava/util/Collection;)Z
    ...
    invoke-virtual {v10, v6, v13}, Landroidx/core/app/SharedElementCallback;->onMapSharedElements(Ljava/util/List;Ljava/util/Map;)V
    ...
    invoke-static/range {v20 .. v20}, Landroidx/core/view/ViewCompat;->getTransitionName(Landroid/view/View;)Ljava/lang/String;
    ...
    .local v38, "exitingCallback":Landroidx/core/app/SharedElementCallback;
    move-object v10, v14
    ...
    .end local v22    # "i":I
    .end local v38    # "exitingCallback":Landroidx/core/app/SharedElementCallback;
    ...
    .restart local v38    # "exitingCallback":Landroidx/core/app/SharedElementCallback;
    :goto_e
    if-gez v21, :cond_14
    ...
    invoke-virtual {v14, v6}, Landroidx/collection/ArrayMap;->retainAll(Ljava/util/Collection;)Z
    ...
    .line 433
    .local v6, "lastInViews":Landroidx/collection/ArrayMap;
    move-object v10, v6
    ...
    invoke-virtual {v6, v10}, Landroidx/collection/ArrayMap;->retainAll(Ljava/util/Collection;)Z
    ...
    invoke-virtual {v5, v10, v12}, Landroidx/core/app/SharedElementCallback;->onMapSharedElements(Ljava/util/List;Ljava/util/Map;)V
    ...
    .end local v5    # "enteringCallback":Landroidx/core/app/SharedElementCallback;
    .local v39, "enteringCallback":Landroidx/core/app/SharedElementCallback;
    ...
    invoke-static {v14, v13}, Landroidx/fragment/app/FragmentTransition;->findKeyForValue(Landroidx/collection/ArrayMap;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 449
    invoke-virtual {v14, v5}, Landroidx/collection/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v21    # "i":I
    .end local v39    # "enteringCallback":Landroidx/core/app/SharedElementCallback;
    .local v5, "enteringCallback":Landroidx/core/app/SharedElementCallback;
    :cond_1d
    move-object/from16 v39, v5

    .end local v5    # "enteringCallback":Landroidx/core/app/SharedElementCallback;
    .restart local v39    # "enteringCallback":Landroidx/core/app/SharedElementCallback;
    goto :goto_12

    .line 460
    .end local v39    # "enteringCallback":Landroidx/core/app/SharedElementCallback;
    .restart local v5    # "enteringCallback":Landroidx/core/app/SharedElementCallback;
    :cond_1e
    move-object/from16 v39, v5

    .end local v5    # "enteringCallback":Landroidx/core/app/SharedElementCallback;
    .restart local v39    # "enteringCallback":Landroidx/core/app/SharedElementCallback;
    invoke-static {v14, v6}, Landroidx/fragment/app/FragmentTransition;->retainValues(Landroidx/collection/ArrayMap;Landroidx/collection/ArrayMap;)V
    ...
    const-string/jumbo v10, "sharedElementNameMapping.keys"
    ...
    .line 472
    .end local v19    # "sharedElementTransition":Ljava/lang/Object;
    ...
    .restart local v19    # "sharedElementTransition":Ljava/lang/Object;
    :cond_1f
    invoke-virtual {v3}, Landroidx/fragment/app/SpecialEffectsController$Operation;->getFragment()Landroidx/fragment/app/Fragment;
    ...
    invoke-static {v5, v10, v1, v7, v12}, Landroidx/fragment/app/FragmentTransition;->callSharedElementStartEnd(Landroidx/fragment/app/Fragment;Landroidx/fragment/app/Fragment;ZLandroidx/collection/ArrayMap;Z)V
    ...
    new-instance v10, Landroidx/fragment/app/DefaultSpecialEffectsController$$ExternalSyntheticLambda3;

    invoke-direct {v10, v3, v2, v1, v6}, Landroidx/fragment/app/DefaultSpecialEffectsController$$ExternalSyntheticLambda3;-><init>(Landroidx/fragment/app/SpecialEffectsController$Operation;Landroidx/fragment/app/SpecialEffectsController$Operation;ZLandroidx/collection/ArrayMap;)V

    invoke-static {v5, v10}, Landroidx/core/view/OneShotPreDrawListener;->add(Landroid/view/View;Ljava/lang/Runnable;)Landroidx/core/view/OneShotPreDrawListener;
    ...
    .line 490
    .local v5, "epicenterViewName":Ljava/lang/String;
    ...
    invoke-virtual {v8, v12, v10}, Landroidx/fragment/app/FragmentTransitionImpl;->setEpicenter(Ljava/lang/Object;Landroid/view/View;)V

    goto :goto_13

    .line 488
    .end local v5    # "epicenterViewName":Ljava/lang/String;
    ...
    .line 493
    .end local v31    # "firstOutEpicenterView":Landroid/view/View;
    .restart local v10    # "firstOutEpicenterView":Landroid/view/View;
    :goto_13
    ...
    .line 498
    .restart local v5    # "epicenterViewName":Ljava/lang/String;
    ...
    .line 499
    .local v15, "lastInEpicenterView":Landroid/view/View;
    if-eqz v15, :cond_21
    ...
    .line 504
    .end local v29    # "hasLastInEpicenter":Z
    .local v18, "hasLastInEpicenter":Z
    move-object/from16 v19, v8

    .line 505
    .local v19, "impl":Landroidx/fragment/app/FragmentTransitionImpl;
    invoke-virtual {v0}, Landroidx/fragment/app/DefaultSpecialEffectsController;->getContainer()Landroid/view/ViewGroup;
    ...
    .local v40, "enteringNames":Ljava/util/ArrayList;
    ...
    .end local v19    # "impl":Landroidx/fragment/app/FragmentTransitionImpl;
    .local v5, "lastInEpicenterRect":Landroid/graphics/Rect;
    .local v6, "impl":Landroidx/fragment/app/FragmentTransitionImpl;
    .local v20, "epicenterViewName":Ljava/lang/String;
    .local v34, "lastInViews":Landroidx/collection/ArrayMap;
    invoke-direct {v4, v6, v15, v5}, Landroidx/fragment/app/DefaultSpecialEffectsController$$ExternalSyntheticLambda4;-><init>(Landroidx/fragment/app/FragmentTransitionImpl;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    .line 499
    .end local v18    # "hasLastInEpicenter":Z
    .end local v20    # "epicenterViewName":Ljava/lang/String;
    .end local v40    # "enteringNames":Ljava/util/ArrayList;
    .restart local v4    # "enteringNames":Ljava/util/ArrayList;
    .local v5, "epicenterViewName":Ljava/lang/String;
    .local v6, "lastInViews":Landroidx/collection/ArrayMap;
    .restart local v29    # "hasLastInEpicenter":Z
    .local v34, "lastInEpicenterRect":Landroid/graphics/Rect;
    :cond_21
    move-object/from16 v40, v4
    ...
    .end local v4    # "enteringNames":Ljava/util/ArrayList;
    .end local v6    # "lastInViews":Landroidx/collection/ArrayMap;
    .local v5, "lastInEpicenterRect":Landroid/graphics/Rect;
    .restart local v20    # "epicenterViewName":Ljava/lang/String;
    .local v34, "lastInViews":Landroidx/collection/ArrayMap;
    .restart local v40    # "enteringNames":Ljava/util/ArrayList;
    goto :goto_14

    .line 496
    .end local v5    # "lastInEpicenterRect":Landroid/graphics/Rect;
    .end local v15    # "lastInEpicenterView":Landroid/view/View;
    .end local v20    # "epicenterViewName":Ljava/lang/String;
    .end local v40    # "enteringNames":Ljava/util/ArrayList;
    .restart local v4    # "enteringNames":Ljava/util/ArrayList;
    .restart local v6    # "lastInViews":Landroidx/collection/ArrayMap;
    .local v34, "lastInEpicenterRect":Landroid/graphics/Rect;
    :cond_22
    move-object/from16 v40, v4
    ...
    .end local v33    # "nonExistentView":Landroid/view/View;
    .local v1, "nonExistentView":Landroid/view/View;
    invoke-virtual {v8, v12, v1, v11}, Landroidx/fragment/app/FragmentTransitionImpl;->setSharedElementTargets(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    .end local v8    # "transitionImpl":Landroidx/fragment/app/FragmentTransitionImpl;
    .end local v12    # "sharedElementTransition":Ljava/lang/Object;
    .end local v13    # "sharedElementLastInViews":Ljava/util/ArrayList;
    .local v18, "transitionImpl":Landroidx/fragment/app/FragmentTransitionImpl;
    .local v19, "sharedElementTransition":Ljava/lang/Object;
    .restart local v25    # "sharedElementLastInViews":Ljava/util/ArrayList;
    ...
    .line 523
    .end local v18    # "transitionImpl":Landroidx/fragment/app/FragmentTransitionImpl;
    .end local v25    # "sharedElementLastInViews":Ljava/util/ArrayList;
    .restart local v8    # "transitionImpl":Landroidx/fragment/app/FragmentTransitionImpl;
    .restart local v13    # "sharedElementLastInViews":Ljava/util/ArrayList;
    const/16 v27, 0x1
    ...
    .end local v32    # "startedTransitions":Ljava/util/Map;
    ...
    .end local v19    # "sharedElementTransition":Ljava/lang/Object;
    .end local v29    # "hasLastInEpicenter":Z
    .end local v34    # "lastInViews":Landroidx/collection/ArrayMap;
    .end local v35    # "firstOutTargetNames":Ljava/util/ArrayList;
    .end local v36    # "firstOutSourceNames":Ljava/util/ArrayList;
    .end local v37    # "numSharedElements":I
    .end local v38    # "exitingCallback":Landroidx/core/app/SharedElementCallback;
    .end local v39    # "enteringCallback":Landroidx/core/app/SharedElementCallback;
    .end local v40    # "enteringNames":Ljava/util/ArrayList;
    ...
    .end local v28    # "hasSharedElementTransition":Z
    ...
    .local v5, "nonExistentView":Landroid/view/View;
    .restart local v7    # "firstOutEpicenterView":Landroid/view/View;
    ...
    .line 534
    .local v9, "mergedNonOverlappingTransition":Ljava/lang/Object;
    invoke-interface/range {p1 .. p1}, Ljava/util/List;->iterator()Ljava/util/Iterator;
    ...
    .end local v11    # "sharedElementFirstOutViews":Ljava/util/ArrayList;
    .local v30, "sharedElementFirstOutViews":Ljava/util/ArrayList;
    invoke-static/range {v16 .. v16}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;
    ...
    .line 541
    .end local v30    # "sharedElementFirstOutViews":Ljava/util/ArrayList;
    .restart local v11    # "sharedElementFirstOutViews":Ljava/util/ArrayList;
    :cond_25
    move-object/from16 v28, v10
    ...
    .end local v11    # "sharedElementFirstOutViews":Ljava/util/ArrayList;
    .restart local v30    # "sharedElementFirstOutViews":Ljava/util/ArrayList;
    ...
    .line 545
    .local v32, "involvedInSharedElementTransition":Z
    if-nez v10, :cond_29
    ...
    .local v33, "sharedElementNameMapping":Landroidx/collection/ArrayMap;
    invoke-static/range {v16 .. v16}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;
    ...
    .line 547
    .end local v33    # "sharedElementNameMapping":Landroidx/collection/ArrayMap;
    ...
    .end local v17    # "transitionInfo":Landroidx/fragment/app/DefaultSpecialEffectsController$TransitionInfo;
    .end local v32    # "involvedInSharedElementTransition":Z
    :goto_17
    ...
    .end local v14    # "sharedElementNameMapping":Landroidx/collection/ArrayMap;
    .restart local v33    # "sharedElementNameMapping":Landroidx/collection/ArrayMap;
    goto :goto_15
    ...
    .restart local v14    # "sharedElementNameMapping":Landroidx/collection/ArrayMap;
    .restart local v17    # "transitionInfo":Landroidx/fragment/app/DefaultSpecialEffectsController$TransitionInfo;
    .restart local v32    # "involvedInSharedElementTransition":Z
    :cond_29
    move-object/from16 v33, v14
    ...
    .end local v13    # "sharedElementLastInViews":Ljava/util/ArrayList;
    .local v34, "sharedElementLastInViews":Ljava/util/ArrayList;
    ...
    invoke-direct {v0, v14, v13}, Landroidx/fragment/app/DefaultSpecialEffectsController;->captureTransitioningViews(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    .line 567
    invoke-virtual {v8, v10, v1}, Landroidx/fragment/app/FragmentTransitionImpl;->addTarget(Ljava/lang/Object;Landroid/view/View;)V
    ...
    .line 569
    :cond_2c
    invoke-virtual {v8, v10, v14}, Landroidx/fragment/app/FragmentTransitionImpl;->addTargets(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    .restart local v18    # "transitionImpl":Landroidx/fragment/app/FragmentTransitionImpl;
    .local v19, "transition":Ljava/lang/Object;
    .local v21, "transitioningViews":Ljava/util/ArrayList;
    invoke-virtual/range {v18 .. v25}, Landroidx/fragment/app/FragmentTransitionImpl;->scheduleRemoveTargets(Ljava/lang/Object;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    .end local v21    # "transitioningViews":Ljava/util/ArrayList;
    .restart local v8    # "transitionImpl":Landroidx/fragment/app/FragmentTransitionImpl;
    .restart local v10    # "transition":Ljava/lang/Object;
    ...
    .line 581
    invoke-virtual {v8, v10, v0, v14}, Landroidx/fragment/app/FragmentTransitionImpl;->scheduleHideFragmentView(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;)V
    ...
    invoke-direct {v1, v12}, Landroidx/fragment/app/DefaultSpecialEffectsController$$ExternalSyntheticLambda5;-><init>(Ljava/util/ArrayList;)V
    ...
    .line 597
    invoke-virtual {v8, v10, v5}, Landroidx/fragment/app/FragmentTransitionImpl;->setEpicenter(Ljava/lang/Object;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v8, v10, v0}, Landroidx/fragment/app/FragmentTransitionImpl;->setEpicenter(Ljava/lang/Object;Landroid/view/View;)V
    ...
    .line 606
    invoke-virtual {v8, v7, v10, v14}, Landroidx/fragment/app/FragmentTransitionImpl;->mergeTransitionsTogether(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 610
    invoke-virtual {v8, v9, v10, v14}, Landroidx/fragment/app/FragmentTransitionImpl;->mergeTransitionsTogether(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .end local v30    # "sharedElementFirstOutViews":Ljava/util/ArrayList;
    .end local v33    # "sharedElementNameMapping":Landroidx/collection/ArrayMap;
    .end local v34    # "sharedElementLastInViews":Ljava/util/ArrayList;
    .restart local v1    # "nonExistentView":Landroid/view/View;
    .local v11, "sharedElementFirstOutViews":Ljava/util/ArrayList;
    .restart local v13    # "sharedElementLastInViews":Ljava/util/ArrayList;
    .local v14, "sharedElementNameMapping":Landroidx/collection/ArrayMap;
    ...
    .end local v14    # "sharedElementNameMapping":Landroidx/collection/ArrayMap;
    .end local v31    # "firstOutEpicenterView":Landroid/view/View;
    .restart local v0    # "firstOutEpicenterView":Landroid/view/View;
    .restart local v24    # "nonExistentView":Landroid/view/View;
    .restart local v30    # "sharedElementFirstOutViews":Ljava/util/ArrayList;
    .restart local v33    # "sharedElementNameMapping":Landroidx/collection/ArrayMap;
    .restart local v34    # "sharedElementLastInViews":Ljava/util/ArrayList;
    nop

    .line 618
    invoke-virtual {v8, v7, v9, v6}, Landroidx/fragment/app/FragmentTransitionImpl;->mergeTransitionsInSequence(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .local v18, "transitionInfo":Landroidx/fragment/app/DefaultSpecialEffectsController$TransitionInfo;
    const/16 v19, 0x0

    .line 631
    .local v19, "$i$a$-filterNot-DefaultSpecialEffectsController$startTransitions$4":I
    ...
    .line 896
    .end local v18    # "transitionInfo":Landroidx/fragment/app/DefaultSpecialEffectsController$TransitionInfo;
    .end local v19    # "$i$a$-filterNot-DefaultSpecialEffectsController$startTransitions$4":I
    if-nez v18, :cond_33
    ...
    .end local v14    # "$i$f$filterNotTo":I
    .restart local v31    # "firstOutEpicenterView":Landroid/view/View;
    move-object v0, v11
    ...
    .line 633
    .local v14, "$i$a$-forEach-DefaultSpecialEffectsController$startTransitions$5":I
    ...
    .line 646
    :goto_1f
    invoke-virtual {v12}, Landroidx/fragment/app/DefaultSpecialEffectsController$TransitionInfo;->completeSpecialEffect()V
    ...
    .end local v4    # "enteringViews":Ljava/util/ArrayList;
    .local v25, "enteringViews":Ljava/util/ArrayList;
    invoke-virtual {v12}, Landroidx/fragment/app/DefaultSpecialEffectsController$TransitionInfo;->getSignal()Landroidx/core/os/CancellationSignal;
    ...
    .end local v5    # "lastInEpicenterRect":Landroid/graphics/Rect;
    .local v28, "lastInEpicenterRect":Landroid/graphics/Rect;
    new-instance v5, Landroidx/fragment/app/DefaultSpecialEffectsController$$ExternalSyntheticLambda6;

    invoke-direct {v5, v12, v0}, Landroidx/fragment/app/DefaultSpecialEffectsController$$ExternalSyntheticLambda6;-><init>(Landroidx/fragment/app/DefaultSpecialEffectsController$TransitionInfo;Landroidx/fragment/app/SpecialEffectsController$Operation;)V

    invoke-virtual {v8, v2, v1, v4, v5}, Landroidx/fragment/app/FragmentTransitionImpl;->setListenerForTransitionEnd(Landroidx/fragment/app/Fragment;Ljava/lang/Object;Landroidx/core/os/CancellationSignal;Ljava/lang/Runnable;)V
    ...
    .end local v12    # "transitionInfo":Landroidx/fragment/app/DefaultSpecialEffectsController$TransitionInfo;
    .end local v14    # "$i$a$-forEach-DefaultSpecialEffectsController$startTransitions$5":I
    .end local v17    # "transition":Ljava/lang/Object;
    ...
    .end local v25    # "enteringViews":Ljava/util/ArrayList;
    .end local v28    # "lastInEpicenterRect":Landroid/graphics/Rect;
    .local v0, "$this$forEach$iv":Ljava/lang/Iterable;
    .restart local v4    # "enteringViews":Ljava/util/ArrayList;
    .restart local v5    # "lastInEpicenterRect":Landroid/graphics/Rect;
    :cond_3b
    move-object/from16 v18, v0
    ...
    .restart local v25    # "enteringViews":Ljava/util/ArrayList;
    .restart local v28    # "lastInEpicenterRect":Landroid/graphics/Rect;
    invoke-virtual/range {p0 .. p0}, Landroidx/fragment/app/DefaultSpecialEffectsController;->getContainer()Landroid/view/ViewGroup;
    ...
    invoke-static {v0, v2}, Landroidx/fragment/app/FragmentTransition;->setViewVisibility(Ljava/util/List;I)V

    .line 670
    move-object/from16 v0, v34

    .end local v34    # "sharedElementLastInViews":Ljava/util/ArrayList;
    .local v0, "sharedElementLastInViews":Ljava/util/ArrayList;
    invoke-virtual {v8, v0}, Landroidx/fragment/app/FragmentTransitionImpl;->prepareSetNameOverridesReordered(Ljava/util/ArrayList;)Ljava/util/ArrayList;

    move-result-object v22

    .line 671
    .local v22, "inNames":Ljava/util/ArrayList;
    invoke-static/range {v26 .. v26}, Landroidx/fragment/app/FragmentManager;->isLoggingEnabled(I)Z
    ...
    const-string/jumbo v10, "sharedElementFirstOutViews"
    ...
    const-string/jumbo v10, "sharedElementLastInViews"
    ...
    .end local v0    # "sharedElementLastInViews":Ljava/util/ArrayList;
    .end local v8    # "transitionImpl":Landroidx/fragment/app/FragmentTransitionImpl;
    .end local v30    # "sharedElementFirstOutViews":Ljava/util/ArrayList;
    .local v18, "transitionImpl":Landroidx/fragment/app/FragmentTransitionImpl;
    .local v20, "sharedElementFirstOutViews":Ljava/util/ArrayList;
    .local v21, "sharedElementLastInViews":Ljava/util/ArrayList;
    ...
    .end local v21    # "sharedElementLastInViews":Ljava/util/ArrayList;
    .local v0, "sharedElementFirstOutViews":Ljava/util/ArrayList;
    .local v2, "sharedElementLastInViews":Ljava/util/ArrayList;
    .restart local v8    # "transitionImpl":Landroidx/fragment/app/FragmentTransitionImpl;
    ...
    invoke-static {v3, v5}, Landroidx/fragment/app/FragmentTransition;->setViewVisibility(Ljava/util/List;I)V
    ...
    .line 691
    invoke-virtual {v8, v6, v0, v2}, Landroidx/fragment/app/FragmentTransitionImpl;->swapSharedElementTargets(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
...
.method public executeOperations(Ljava/util/List;Z)V
    ...
    .line 66
    .local v12, "animations":Ljava/util/List;
    new-instance v1, Ljava/util/ArrayList;
    ...
    .line 67
    .local v1, "transitions":Ljava/util/List;
    move-object v2, v6
    ...
    .line 70
    .local v2, "awaitingContainerChanges":Ljava/util/List;
    ...
    .line 74
    .local v15, "animCancellationSignal":Landroidx/core/os/CancellationSignal;
    invoke-virtual {v14, v15}, Landroidx/fragment/app/SpecialEffectsController$Operation;->markStartedSpecialEffect(Landroidx/core/os/CancellationSignal;)V
    ...
    invoke-direct {v7, v14, v15, v3}, Landroidx/fragment/app/DefaultSpecialEffectsController$AnimationInfo;-><init>(Landroidx/fragment/app/SpecialEffectsController$Operation;Landroidx/core/os/CancellationSignal;Z)V
    ...
    .line 80
    .local v7, "transitionCancellationSignal":Landroidx/core/os/CancellationSignal;
    invoke-virtual {v14, v7}, Landroidx/fragment/app/SpecialEffectsController$Operation;->markStartedSpecialEffect(Landroidx/core/os/CancellationSignal;)V
    ...
    .line 82
    invoke-direct {v9, v14, v7, v3, v10}, Landroidx/fragment/app/DefaultSpecialEffectsController$TransitionInfo;-><init>(Landroidx/fragment/app/SpecialEffectsController$Operation;Landroidx/core/os/CancellationSignal;ZZ)V
    ...
    invoke-direct {v9, v2, v14, v0}, Landroidx/fragment/app/DefaultSpecialEffectsController$$ExternalSyntheticLambda2;-><init>(Ljava/util/List;Landroidx/fragment/app/SpecialEffectsController$Operation;Landroidx/fragment/app/DefaultSpecialEffectsController;)V

    invoke-virtual {v14, v9}, Landroidx/fragment/app/SpecialEffectsController$Operation;->addCompletionListener(Ljava/lang/Runnable;)V

    move/from16 v7, v16

    .end local v7    # "transitionCancellationSignal":Landroidx/core/os/CancellationSignal;
    .end local v14    # "operation":Landroidx/fragment/app/SpecialEffectsController$Operation;
    .end local v15    # "animCancellationSignal":Landroidx/core/os/CancellationSignal;
    goto :goto_4
    ...
    .line 98
    .local v7, "startedTransitions":Ljava/util/Map;
    ...
    .line 101
    invoke-direct {v0, v12, v2, v3, v7}, Landroidx/fragment/app/DefaultSpecialEffectsController;->startAnimations(Ljava/util/List;Ljava/util/List;ZLjava/util/Map;)V
    ...
    invoke-direct {v0, v10}, Landroidx/fragment/app/DefaultSpecialEffectsController;->applyContainerChanges(Landroidx/fragment/app/SpecialEffectsController$Operation;)V
    ...
    const-string v10, "Completed executing operations from "
