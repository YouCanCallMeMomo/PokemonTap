...
.method public static synthetic joinToString$default(Landroidx/collection/LongLongMap;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Lkotlin/jvm/functions/Function2;ILjava/lang/Object;)Ljava/lang/String;
    ...
    .local p4, "this_$iv":Landroidx/collection/LongLongMap;
    .local p5, "$i$f$forEach":I
    .local p7, "$i$a$-buildString-LongLongMap$joinToString$2":I
    .local p8, "index":I
    not-long v11, v9
    ...
    .line 1282
    .local v21, "$i$a$-forEachIndexed-LongLongMap$forEach$1$iv":I
    ...
    .line 530
    .local v26, "$i$a$-forEach-LongLongMap$joinToString$2$1":I
    if-ne v11, v4, :cond_6
    ...
    .end local v26    # "$i$a$-forEach-LongLongMap$joinToString$2$1":I
    nop
    ...
    .end local v21    # "$i$a$-forEachIndexed-LongLongMap$forEach$1$iv":I
    goto :goto_8
    ...
    .end local v28    # "separator":Ljava/lang/CharSequence;
    .end local p4    # "this_$iv":Landroidx/collection/LongLongMap;
    .end local p5    # "$i$f$forEach":I
    .end local p7    # "$i$a$-buildString-LongLongMap$joinToString$2":I
    .restart local v1    # "separator":Ljava/lang/CharSequence;
    .local v9, "$i$a$-buildString-LongLongMap$joinToString$2":I
    .local v11, "this_$iv":Landroidx/collection/LongLongMap;
    .local v12, "$i$f$forEach":I
    ...
    .end local v12    # "$i$f$forEach":I
    .restart local v28    # "separator":Ljava/lang/CharSequence;
    .restart local p4    # "this_$iv":Landroidx/collection/LongLongMap;
    .restart local p5    # "$i$f$forEach":I
    .restart local p7    # "$i$a$-buildString-LongLongMap$joinToString$2":I
    :cond_c
    move v11, v10
...
.method public final all(Lkotlin/jvm/functions/Function2;)Z
    ...
    .line 422
    .local v20, "$i$a$-forEach-LongLongMap$all$1":I
    move/from16 v26, v12
    ...
    .line 1127
    .end local v20    # "$i$a$-forEach-LongLongMap$all$1":I
    .end local v22    # "key":J
    .end local v24    # "value":J
    nop
...
.method public final any(Lkotlin/jvm/functions/Function2;)Z
    ...
    .line 432
    .local v20, "$i$a$-forEach-LongLongMap$any$1":I
    move/from16 v26, v12
    ...
    .line 1153
    .end local v20    # "$i$a$-forEach-LongLongMap$any$1":I
    .end local v22    # "key":J
    .end local v24    # "value":J
    nop
...
.method public final count(Lkotlin/jvm/functions/Function2;)I
    ...
    .local v26, "this_$iv":Landroidx/collection/LongLongMap;
    invoke-static/range {v22 .. v23}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;
    ...
    .end local v26    # "this_$iv":Landroidx/collection/LongLongMap;
    ...
    .line 1181
    .end local v3    # "this_$iv":Landroidx/collection/LongLongMap;
    .restart local v26    # "this_$iv":Landroidx/collection/LongLongMap;
    :goto_3
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .end local v3    # "this_$iv":Landroidx/collection/LongLongMap;
    .local v20, "this_$iv":Landroidx/collection/LongLongMap;
    aget-wide v2, v6, v17
    ...
    .line 577
    .local v24, "$i$a$-forEach-LongLongMap$equals$1":I
    move/from16 v25, v15
    ...
    .end local v2    # "key":J
    .end local v22    # "value":J
    .end local v24    # "$i$a$-forEach-LongLongMap$equals$1":I
    nop
    ...
    .end local v20    # "this_$iv":Landroidx/collection/LongLongMap;
    .restart local v3    # "this_$iv":Landroidx/collection/LongLongMap;
    :cond_5
    move/from16 v21, v2
    ...
    .line 1336
    .end local v3    # "this_$iv":Landroidx/collection/LongLongMap;
    .restart local v20    # "this_$iv":Landroidx/collection/LongLongMap;
    :goto_3
...
.method public final joinToString(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;)Ljava/lang/String;
    ...
    .end local v26    # "k$iv":[J
    .end local v27    # "j$iv$iv":I
    ...
    .restart local v26    # "k$iv":[J
    .restart local v27    # "j$iv$iv":I
    :goto_3
...
.method public final joinToString(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Lkotlin/jvm/functions/Function2;)Ljava/lang/String;
    ...
    .local v23, "$i$a$-buildString-LongLongMap$joinToString$2":I
    .local v24, "index":I
    not-long v10, v8
    ...
    .end local v23    # "$i$a$-buildString-LongLongMap$joinToString$2":I
    .local v8, "$i$a$-buildString-LongLongMap$joinToString$2":I
    ...
    .restart local v23    # "$i$a$-buildString-LongLongMap$joinToString$2":I
    move v10, v0
...
.method public final joinToString(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILkotlin/jvm/functions/Function2;)Ljava/lang/String;
    ...
    .local v21, "$i$a$-buildString-LongLongMap$joinToString$2$iv":I
    .local v22, "index$iv":I
    ...
    .local v33, "truncated$iv":Ljava/lang/CharSequence;
    ...
    .end local v33    # "truncated$iv":Ljava/lang/CharSequence;
    ...
    .line 1425
    .end local v5    # "truncated$iv":Ljava/lang/CharSequence;
    .restart local v33    # "truncated$iv":Ljava/lang/CharSequence;
    :goto_3
    ...
    .end local v21    # "$i$a$-buildString-LongLongMap$joinToString$2$iv":I
    ...
    .end local v6    # "$i$f$joinToString":I
    .end local v9    # "$i$a$-buildString-LongLongMap$joinToString$2$iv":I
    .restart local v21    # "$i$a$-buildString-LongLongMap$joinToString$2$iv":I
...
.method public final joinToString(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lkotlin/jvm/functions/Function2;)Ljava/lang/String;
    ...
    .local v22, "$i$a$-buildString-LongLongMap$joinToString$2$iv":I
    ...
    .end local v22    # "$i$a$-buildString-LongLongMap$joinToString$2$iv":I
    ...
    .end local v10    # "$i$a$-buildString-LongLongMap$joinToString$2$iv":I
    .restart local v22    # "$i$a$-buildString-LongLongMap$joinToString$2$iv":I
...
.method public final joinToString(Ljava/lang/CharSequence;Lkotlin/jvm/functions/Function2;)Ljava/lang/String;
    ...
    .end local v11    # "index$iv":I
    .local v7, "$this$maskEmptyOrDeleted$iv$iv$iv$iv":J
    .local v23, "$i$a$-buildString-LongLongMap$joinToString$2$iv":I
    .local v24, "index$iv":I
    ...
    .end local v23    # "$i$a$-buildString-LongLongMap$joinToString$2$iv":I
    ...
    .end local v7    # "$i$f$joinToString":I
    .end local v10    # "$i$a$-buildString-LongLongMap$joinToString$2$iv":I
    .restart local v23    # "$i$a$-buildString-LongLongMap$joinToString$2$iv":I
...
.method public final joinToString(Lkotlin/jvm/functions/Function2;)Ljava/lang/String;
    ...
    .local v35, "separator$iv":Ljava/lang/CharSequence;
    invoke-static/range {v31 .. v32}, Ljava/lang/Long;->valueOf(J)Ljava/lang/Long;
    ...
    .line 1605
    .end local v24    # "index$iv$iv$iv":I
    .end local v35    # "separator$iv":Ljava/lang/CharSequence;
    ...
    .line 1621
    .end local v2    # "separator$iv":Ljava/lang/CharSequence;
    .restart local v35    # "separator$iv":Ljava/lang/CharSequence;
    :goto_3
    shr-long v21, v21, v34
