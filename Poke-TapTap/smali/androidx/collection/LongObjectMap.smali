...
.method public static synthetic joinToString$default(Landroidx/collection/LongObjectMap;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Lkotlin/jvm/functions/Function2;ILjava/lang/Object;)Ljava/lang/String;
    ...
    .local p4, "this_$iv":Landroidx/collection/LongObjectMap;
    .local p5, "$i$f$forEach":I
    .local p7, "$i$a$-buildString-LongObjectMap$joinToString$2":I
    .local p8, "index":I
    not-long v11, v9
    ...
    .line 1429
    .local v21, "$i$a$-forEachIndexed-LongObjectMap$forEach$1$iv":I
    ...
    .end local v21    # "$i$a$-forEachIndexed-LongObjectMap$forEach$1$iv":I
    goto :goto_8
    ...
    .end local v26    # "separator":Ljava/lang/CharSequence;
    .end local p4    # "this_$iv":Landroidx/collection/LongObjectMap;
    .end local p5    # "$i$f$forEach":I
    .end local p7    # "$i$a$-buildString-LongObjectMap$joinToString$2":I
    .restart local v1    # "separator":Ljava/lang/CharSequence;
    .local v9, "$i$a$-buildString-LongObjectMap$joinToString$2":I
    .local v11, "this_$iv":Landroidx/collection/LongObjectMap;
    .local v12, "$i$f$forEach":I
    ...
    .end local v12    # "$i$f$forEach":I
    .restart local v26    # "separator":Ljava/lang/CharSequence;
    .restart local p4    # "this_$iv":Landroidx/collection/LongObjectMap;
    .restart local p5    # "$i$f$forEach":I
    .restart local p7    # "$i$a$-buildString-LongObjectMap$joinToString$2":I
    :cond_c
    move v11, v10
...
.method public final all(Lkotlin/jvm/functions/Function2;)Z
    ...
    .line 421
    .local v24, "$i$a$-forEach-LongObjectMap$all$1":I
    move/from16 v25, v1
    ...
    .end local v22    # "key":J
    .end local v24    # "$i$a$-forEach-LongObjectMap$all$1":I
    nop
...
.method public final any(Lkotlin/jvm/functions/Function2;)Z
    ...
    .line 431
    .local v24, "$i$a$-forEach-LongObjectMap$any$1":I
    move/from16 v25, v1
    ...
    .end local v12    # "value":Ljava/lang/Object;
    .end local v22    # "key":J
    .end local v24    # "$i$a$-forEach-LongObjectMap$any$1":I
    nop
...
.method public final contains(J)Z
    ...
    .local v7, "$this$hasNext$iv$iv":J
    const/4 v9, 0x0

    .line 1276
    .local v9, "$i$f$hasNext":I
    ...
    .end local v7    # "$this$hasNext$iv$iv":J
    .end local v9    # "$i$f$hasNext":I
    :goto_2
    if-eqz v7, :cond_2
    ...
    .local v10, "$this$lowestBitSet$iv$iv$iv":J
    const/4 v14, 0x0
    ...
    .line 1278
    .end local v10    # "$this$lowestBitSet$iv$iv$iv":J
    .end local v14    # "$i$f$lowestBitSet":I
    nop

    .line 1277
    .end local v7    # "$this$get$iv$iv":J
    ...
    .line 1283
    .end local v8    # "$this$next$iv$iv":J
    ...
    .local v7, "$this$maskEmpty$iv$iv":J
    const/4 v9, 0x0

    .line 1286
    .local v9, "$i$f$maskEmpty":I
    ...
    .line 1285
    .end local v7    # "$this$maskEmpty$iv$iv":J
    .end local v9    # "$i$f$maskEmpty":I
    cmp-long v7, v7, v21
...
.method public final count(Lkotlin/jvm/functions/Function2;)I
    ...
    .line 447
    .local v23, "$i$a$-forEach-LongObjectMap$count$1":I
    ...
    .end local v20    # "key":J
    .end local v23    # "$i$a$-forEach-LongObjectMap$count$1":I
    nop
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 576
    .local v23, "$i$a$-forEach-LongObjectMap$equals$1":I
    if-nez v15, :cond_5
    ...
    .end local v23    # "$i$a$-forEach-LongObjectMap$equals$1":I
    nop
...
.method public final findKeyIndex$collection(J)I
    ...
    .end local v7    # "$this$hasNext$iv":J
    .end local v9    # "$i$f$hasNext":I
    :goto_2
    if-eqz v14, :cond_2
    ...
    .local v10, "$this$lowestBitSet$iv$iv":J
    const/4 v14, 0x0
    ...
    .line 1528
    .end local v10    # "$this$lowestBitSet$iv$iv":J
    .end local v14    # "$i$f$lowestBitSet":I
    nop

    .line 630
    .end local v7    # "$this$get$iv":J
    .end local v9    # "$i$f$get":I
    add-int/2addr v10, v5
    ...
    .line 637
    .end local v7    # "$this$maskEmpty$iv":J
    .end local v9    # "$i$f$maskEmpty":I
    cmp-long v7, v7, v19
...
.method public final joinToString(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Lkotlin/jvm/functions/Function2;)Ljava/lang/String;
    ...
    .local v23, "$i$a$-buildString-LongObjectMap$joinToString$2":I
    .local v24, "index":I
    not-long v10, v8
    ...
    .line 529
    .local v29, "$i$a$-forEach-LongObjectMap$joinToString$2$1":I
    ...
    .end local v26    # "key":J
    .end local v29    # "$i$a$-forEach-LongObjectMap$joinToString$2$1":I
    nop
    ...
    .end local v23    # "$i$a$-buildString-LongObjectMap$joinToString$2":I
    .local v8, "$i$a$-buildString-LongObjectMap$joinToString$2":I
    .local v10, "this_$iv":Landroidx/collection/LongObjectMap;
    .local v11, "$i$f$forEach":I
    :cond_6
    ...
    .restart local v23    # "$i$a$-buildString-LongObjectMap$joinToString$2":I
    :cond_7
    move v10, v9
...
.method public final joinToString(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILkotlin/jvm/functions/Function2;)Ljava/lang/String;
    ...
    .local v21, "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    .local v22, "index$iv":I
    .local v24, "$i$f$joinToString":I
    not-long v9, v6
    ...
    .end local v31    # "j$iv$iv$iv":I
    .restart local v9    # "j$iv$iv$iv":I
    :cond_3
    move/from16 v29, v7
    ...
    .line 1572
    .end local v9    # "j$iv$iv$iv":I
    .restart local v31    # "j$iv$iv$iv":I
    :goto_3
    ...
    .end local v21    # "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    .end local v24    # "$i$f$joinToString":I
    .local v6, "$i$f$joinToString":I
    .local v9, "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    :cond_6
    move/from16 v24, v6
    ...
    .end local v6    # "$i$f$joinToString":I
    .end local v9    # "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    .restart local v21    # "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    .restart local v24    # "$i$f$joinToString":I
    :cond_7
    nop
...
.method public final joinToString(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lkotlin/jvm/functions/Function2;)Ljava/lang/String;
    ...
    .local v22, "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    .local v23, "index$iv":I
    .local v25, "$i$f$joinToString":I
    not-long v10, v7
    ...
    .end local v22    # "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    .end local v25    # "$i$f$joinToString":I
    .local v7, "$i$f$joinToString":I
    .local v10, "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    :cond_6
    move/from16 v25, v7
    ...
    .end local v10    # "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    .restart local v22    # "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    .restart local v25    # "$i$f$joinToString":I
    :cond_7
    nop
...
.method public final joinToString(Ljava/lang/CharSequence;Lkotlin/jvm/functions/Function2;)Ljava/lang/String;
    ...
    .end local v11    # "index$iv":I
    .local v7, "$this$maskEmptyOrDeleted$iv$iv$iv$iv":J
    .local v23, "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    .local v24, "index$iv":I
    .local v26, "$i$f$joinToString":I
    not-long v10, v7
    ...
    .line 1708
    .local v32, "$i$a$-forEach-LongObjectMap$joinToString$2$1$iv":I
    if-ne v11, v5, :cond_1
    ...
    .end local v32    # "$i$a$-forEach-LongObjectMap$joinToString$2$1$iv":I
    nop
    ...
    .end local v23    # "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    .end local v26    # "$i$f$joinToString":I
    .local v7, "$i$f$joinToString":I
    .local v10, "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    :cond_6
    move/from16 v26, v7
    ...
    .end local v7    # "$i$f$joinToString":I
    .end local v10    # "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    .restart local v23    # "$i$a$-buildString-LongObjectMap$joinToString$2$iv":I
    .restart local v26    # "$i$f$joinToString":I
    :cond_7
    nop
