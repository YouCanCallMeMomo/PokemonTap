...
.method public static synthetic joinToString$default(Landroidx/collection/ObjectIntMap;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Lkotlin/jvm/functions/Function2;ILjava/lang/Object;)Ljava/lang/String;
    ...
    .local p4, "this_$iv":Landroidx/collection/ObjectIntMap;
    .local p5, "$i$f$forEach":I
    .local p7, "$i$a$-buildString-ObjectIntMap$joinToString$2":I
    .local p8, "index":I
    not-long v11, v9
    ...
    .line 548
    .local v22, "$i$a$-forEach-ObjectIntMap$joinToString$2$1":I
    if-ne v11, v4, :cond_6
    ...
    .end local v22    # "$i$a$-forEach-ObjectIntMap$joinToString$2$1":I
    ...
    .end local v25    # "separator":Ljava/lang/CharSequence;
    .end local p4    # "this_$iv":Landroidx/collection/ObjectIntMap;
    .end local p5    # "$i$f$forEach":I
    .end local p7    # "$i$a$-buildString-ObjectIntMap$joinToString$2":I
    .restart local v1    # "separator":Ljava/lang/CharSequence;
    .local v9, "$i$a$-buildString-ObjectIntMap$joinToString$2":I
    .local v11, "this_$iv":Landroidx/collection/ObjectIntMap;
    .local v12, "$i$f$forEach":I
    ...
    .end local v12    # "$i$f$forEach":I
    .restart local v25    # "separator":Ljava/lang/CharSequence;
    .restart local p4    # "this_$iv":Landroidx/collection/ObjectIntMap;
    .restart local p5    # "$i$f$forEach":I
    .restart local p7    # "$i$a$-buildString-ObjectIntMap$joinToString$2":I
    :cond_c
    move v11, v10
...
.method public final all(Lkotlin/jvm/functions/Function2;)Z
    ...
    .line 440
    .local v23, "$i$a$-forEach-ObjectIntMap$all$1":I
    move/from16 v24, v1
    ...
    .end local v23    # "$i$a$-forEach-ObjectIntMap$all$1":I
    nop
...
.method public final any(Lkotlin/jvm/functions/Function2;)Z
    ...
    .line 450
    .local v23, "$i$a$-forEach-ObjectIntMap$any$1":I
    move/from16 v24, v1
    ...
    .end local v12    # "key":Ljava/lang/Object;
    .end local v22    # "value":I
    .end local v23    # "$i$a$-forEach-ObjectIntMap$any$1":I
    nop
...
.method public final count(Lkotlin/jvm/functions/Function2;)I
    ...
    .local v24, "this_$iv":Landroidx/collection/ObjectIntMap;
    ...
    .end local v24    # "this_$iv":Landroidx/collection/ObjectIntMap;
    .local v3, "this_$iv":Landroidx/collection/ObjectIntMap;
    :cond_2
    move/from16 v23, v2
    ...
    .restart local v24    # "this_$iv":Landroidx/collection/ObjectIntMap;
    :goto_3
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 1361
    .local v20, "$i$a$-forEachIndexed-ObjectIntMap$forEach$1$iv":I
    move/from16 v21, v2
    ...
    .line 598
    .local v22, "$i$a$-forEach-ObjectIntMap$equals$1":I
    move/from16 v23, v4
    ...
    .end local v22    # "$i$a$-forEach-ObjectIntMap$equals$1":I
    nop
    ...
    .end local v20    # "$i$a$-forEachIndexed-ObjectIntMap$forEach$1$iv":I
    goto :goto_3

    .line 1357
    .end local v5    # "index$iv$iv":I
    .end local v23    # "j$iv$iv":I
...
.method public final joinToString(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILjava/lang/CharSequence;Lkotlin/jvm/functions/Function2;)Ljava/lang/String;
    ...
    .local v23, "$i$a$-buildString-ObjectIntMap$joinToString$2":I
    .local v24, "index":I
    not-long v10, v8
    ...
    .end local v23    # "$i$a$-buildString-ObjectIntMap$joinToString$2":I
    .local v8, "$i$a$-buildString-ObjectIntMap$joinToString$2":I
    ...
    .restart local v23    # "$i$a$-buildString-ObjectIntMap$joinToString$2":I
    move v10, v0
...
.method public final joinToString(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILkotlin/jvm/functions/Function2;)Ljava/lang/String;
    ...
    .local v21, "$i$a$-buildString-ObjectIntMap$joinToString$2$iv":I
    .local v22, "index$iv":I
    ...
    .end local v21    # "$i$a$-buildString-ObjectIntMap$joinToString$2$iv":I
    ...
    .end local v6    # "$i$f$joinToString":I
    .end local v9    # "$i$a$-buildString-ObjectIntMap$joinToString$2$iv":I
    .restart local v21    # "$i$a$-buildString-ObjectIntMap$joinToString$2$iv":I
...
.method public final joinToString(Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lkotlin/jvm/functions/Function2;)Ljava/lang/String;
    ...
    .local v22, "$i$a$-buildString-ObjectIntMap$joinToString$2$iv":I
    ...
    .end local v22    # "$i$a$-buildString-ObjectIntMap$joinToString$2$iv":I
    ...
    .end local v10    # "$i$a$-buildString-ObjectIntMap$joinToString$2$iv":I
    .restart local v22    # "$i$a$-buildString-ObjectIntMap$joinToString$2$iv":I
...
.method public final joinToString(Ljava/lang/CharSequence;Lkotlin/jvm/functions/Function2;)Ljava/lang/String;
    ...
    .end local v11    # "index$iv":I
    .local v7, "$this$maskEmptyOrDeleted$iv$iv$iv$iv":J
    .local v23, "$i$a$-buildString-ObjectIntMap$joinToString$2$iv":I
    .local v24, "index$iv":I
    ...
    .end local v23    # "$i$a$-buildString-ObjectIntMap$joinToString$2$iv":I
    ...
    .end local v7    # "$i$f$joinToString":I
    .end local v10    # "$i$a$-buildString-ObjectIntMap$joinToString$2$iv":I
    .restart local v23    # "$i$a$-buildString-ObjectIntMap$joinToString$2$iv":I
