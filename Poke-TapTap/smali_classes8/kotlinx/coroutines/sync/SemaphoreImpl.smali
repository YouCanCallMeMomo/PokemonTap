...
.method private final addAcquireToQueue(Lkotlinx/coroutines/Waiter;)Z
    ...
    .local v19, "$i$f$moveForward$atomicfu":I
    ...
    .end local v19    # "$i$f$moveForward$atomicfu":I
    :goto_2
    if-eqz v2, :cond_3
    ...
    .restart local v19    # "$i$f$moveForward$atomicfu":I
    :cond_4
...
.method private final tryResumeNextFromQueue()Z
    ...
    .local v19, "curHead":Lkotlinx/coroutines/sync/SemaphoreSegment;
    .local v20, "deqIdx":J
    ...
    .restart local v13    # "$i$f$moveForward$atomicfu":I
    ...
    .end local v13    # "$i$f$moveForward$atomicfu":I
    .end local v14    # "$i$f$loop$atomicfu":I
    .end local v19    # "curHead":Lkotlinx/coroutines/sync/SemaphoreSegment;
    .end local v20    # "deqIdx":J
    ...
    .restart local v19    # "curHead":Lkotlinx/coroutines/sync/SemaphoreSegment;
    .restart local v20    # "deqIdx":J
    :goto_3
    invoke-static {v9}, Lkotlinx/coroutines/internal/SegmentOrClosed;->getSegment-impl(Ljava/lang/Object;)Lkotlinx/coroutines/internal/Segment;
